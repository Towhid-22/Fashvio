      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 lg:grid-cols-7 xl:grid-cols-10 2xl:grid-cols-12 gap-4 place-items-center">
        {categories.map((item) => (
          <Link href={`/shop/${item.slug}`}>
            <div
              key={item.id}
              className="shadow p-3 flex flex-col items-center w-30 h-30 justify-center rounded-[5px] cursor-pointer hover:bg-primaryColor/20 transition-all duration-300"
            >
